...
function calcularEquivalencia() {
  ...
  var valorConvertir = parseFloat(
    document.getElementById("datos-convertir").value
  );
  ...
  if (unidadPartida == "Byte") {
    ...
    document.getElementById("valor-gigabyte").value =
      valorConvertir / 1000000000;
    document.getElementById("valor-terabyte").value =
      valorConvertir / 1000000000000;
  }
  ...
  if (unidadPartida == "Terabyte") {
    document.getElementById("valor-byte").value =
      valorConvertir * 1000000000000;
    document.getElementById("valor-kilobyte").value =
      valorConvertir * 1000000000;
    document.getElementById("valor-megabyte").value = valorConvertir * 1000000;
    document.getElementById("valor-gigabyte").value = valorConvertir * 1000;
